...
<form action="statusloanservlet">
<div class="abcde">
        <div class="container">
          <h1 text-align="center">Loan status</h1>
          
      
              <label for="email"><b>loan id</b></label>
            <input type="text" name="lid" placeholder="Enter your loan id" required>
