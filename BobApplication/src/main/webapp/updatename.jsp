...
<div class="abcde">
        <div class="container">
          ...
          <label for="email"><b>Enter the name to be updated</b></label>
          <input type="text" placeholder="enter updation name" name="fname" required>
          ...
          if(flag==true){ %>
        	  ...
        	  <div class="animate-charcter text-center" style="color : red" >Name updated</div>
