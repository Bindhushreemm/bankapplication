  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav ms-auto">
     <li class="nav-item active">
        <a class="nav-link" href="options.jsp">services <span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item active">
...
<form action="CustomerDeposit">
<div class="abcde">
        <div class="container">
          <h1 text-align="center">Deposit</h1>
          
      
              <label for="email"><b>Mpin</b></label>
            <input type="password" name="mpin" placeholder="Enter your mpin" required>
          <label for="email"><b>Amount to be deposited</b></label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          <input type="number" placeholder="enter amount to be deposited" name="damount" min="1" required><br><br>
          
        
      
          
      
           <div class="buttonbox"> <div class="buttons"><button type="submit" class="button1">deposit</button></div></div>
