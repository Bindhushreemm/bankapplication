...
<nav class="navbar navbar-expand-lg navbar-light ">
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav ms-auto">
      ...
      <li class="nav-item">
        <a class="nav-link " href="login.jsp">services</a>
      </li>
      <li class="nav-item">
...
<!-- image carousal effect -->
<div class="sidebarr" height="1620px">
					<div class="box1" >
					<div class="get" style="float: left; width: 60%">
					<div class="slider">
					...
					<!-- --image middle carousal -->
					<br style="clear:both">
					 <div class="get" style="clear:both" class="box2">
					<div class="abox">
					<div class="check">
					  <div class="acolumn">
					    <div class="acard">
      ...
      <div class="site-section">
        <div class="container">
          ...
          <div class="cta d-block d-md-flex align-items-center px-5">
            ...
            <div class="ms-auto">
              <a href="register.jsp" class="btn btn-dark rounded-0 py-3 px-5">open an account</a>
            </div>
          </div>
          <div class="row">
