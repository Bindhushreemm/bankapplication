...
<div class="abcde">
        <div class="container">
          ...
          <label for="email"><b>Enter the phonenumber to be updated</b></label>
          <input type="text" placeholder="enter updation phone number" name="pno" required>
          ...
          if(flag==true){ %>
        	  ...
        	  <div class="animate-charcter text-center" style="color : red" >phone number updated</div>
