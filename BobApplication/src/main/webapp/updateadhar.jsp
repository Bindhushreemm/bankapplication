...
<div class="abcde">
        <div class="container">
          ...
          <label for="email"><b>Enter the adharnumber to be updated</b></label>
          <input type="text" placeholder="enter updation adhar number" name="ano" required>
          ...
          if(flag==true){ %>
        	  ...
        	  <div class="animate-charcter text-center" style="color : red" >adhar number updated</div>
